...
Select package manager of choice and wait for the installation to complete
...
Create a .env file in root of the folder and remember to add it to the gitignore file

## Run the app

To run the app in watch mode use npm run start:dev

## Add entities to respective modules

imports: TypeOrmModule.forFeature([ChampionshipRound])]

use autoLoadEntities: true in TypeOrmModule.forRoot() in AppModule
